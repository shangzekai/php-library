...
/**
 * Generate_PHPExcel_CachedObjectStorage_CacheBase
 *
 * @category   Generate_PHPExcel
 * @package    Generate_PHPExcel_CachedObjectStorage
 * @copyright  Copyright (c) 2006 - 2014 Generate_PHPExcel (http://www.codeplex.com/Generate_PHPExcel)
 */
abstract class Generate_PHPExcel_CachedObjectStorage_CacheBase {
	 ...
	 */
	public function __construct(Generate_PHPExcel_Worksheet $parent) {
		//	Set our parent worksheet.
		//	This is maintained within the cache controller to facilitate re-attaching it to Generate_PHPExcel_Cell objects when
     ...
     */
	public function updateCacheData(Generate_PHPExcel_Cell $cell) {
	...
	public function getHighestColumn($row = null)
	{
        ...
        foreach ($this->getCellList() as $coord) {
            ...
            $columnList[] = Generate_PHPExcel_Cell::columnIndexFromString($c);
        }
        return Generate_PHPExcel_Cell::stringFromColumnIndex(max($columnList) - 1);
    }
