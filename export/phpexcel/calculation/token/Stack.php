...
/**
 * Generate_PHPExcel_Calculation_Token_Stack
 *
 * @category	Generate_PHPExcel_Calculation_Token_Stack
 * @package		Generate_PHPExcel_Calculation
 * @copyright	Copyright (c) 2006 - 2014 Generate_PHPExcel (http://www.codeplex.com/Generate_PHPExcel)
 */
class Generate_PHPExcel_Calculation_Token_Stack {
	...
	public function push($type, $value, $reference = NULL) {
		...
		if ($type == 'Function') {
			$localeFunction = Generate_PHPExcel_Calculation::_localeFunc($value);
