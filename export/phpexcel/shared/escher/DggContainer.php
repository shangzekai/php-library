...
/**
 * Generate_PHPExcel_Shared_Escher_DggContainer
 *
 * @category   Generate_PHPExcel
 * @package    Generate_PHPExcel_Shared_Escher
 * @copyright  Copyright (c) 2006 - 2014 Generate_PHPExcel (http://www.codeplex.com/Generate_PHPExcel)
 */
class Generate_PHPExcel_Shared_Escher_DggContainer
{
	/**
	 ...
	 *
	 * @return Generate_PHPExcel_Shared_Escher_DggContainer_BstoreContainer
	 */
	 ...
	 *
	 * @param Generate_PHPExcel_Shared_Escher_DggContainer_BstoreContainer $bstoreContainer
	 */
