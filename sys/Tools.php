...
class Sys_Tools {
    ...
    public static function convertSecond($second)
    {
        $result = array(
            'year'   => 0,
            'month'  => 0,
        ...
        if($second >= 31536000) {
            $result['year'] = floor($second / 31536000);
            $second = $second % 31536000;
        }
        if($second >= 2628000) {
            $result['month'] = floor($second / 2628000);
            $second = $second % 2628000;
        }
        if($second >= 86400) {
            $result['day'] = floor($second / 86400);
            $second = $second % 86400;
        }
        if($second >= 3600) {
            $result['hour'] = floor($second / 3600);
            $second = $second % 3600;
        }
        if($second >= 60) {
            $result['minute'] = floor($second / 60);
            $second = $second % 60;
        }
        if($second >= 0) {
    ...
    public static function response($data, $contentType) {
