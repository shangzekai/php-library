 ...
 * @package    Generate_PHPExcel_Shared_ZipArchive
...
if (!defined('PCLZIP_TEMPORARY_DIR')) {
	define('PCLZIP_TEMPORARY_DIR', Generate_PHPExcel_Shared_File::sys_get_temp_dir());
}
require_once Generate_PHPExcel_ROOT . 'Generate_PHPExcel/Shared/PCLZip/pclzip.lib.php';


/**
 * Generate_PHPExcel_Shared_ZipArchive
 *
 * @category   Generate_PHPExcel
 * @package    Generate_PHPExcel_Shared_ZipArchive
 * @copyright  Copyright (c) 2006 - 2014 Generate_PHPExcel (http://www.codeplex.com/Generate_PHPExcel)
 */
class Generate_PHPExcel_Shared_ZipArchive
{
	...
	public function addFromString($localname, $contents)
	{
		...
		if ($res == 0) {
			throw new Generate_PHPExcel_Writer_Exception("Error zipping files : " . $this->_zip->errorInfo(true));
		}
