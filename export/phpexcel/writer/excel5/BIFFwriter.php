...
/**
 * Generate_PHPExcel_Writer_Excel5_BIFFwriter
 *
 * @category   Generate_PHPExcel
 * @package    Generate_PHPExcel_Writer_Excel5
 * @copyright  Copyright (c) 2006 - 2014 Generate_PHPExcel (http://www.codeplex.com/Generate_PHPExcel)
 */
class Generate_PHPExcel_Writer_Excel5_BIFFwriter
{
	/**
	...
	public static function getByteOrder()
	{
		if (!isset(self::$_byte_order)) {
			...
			if ($number == $teststr) {
				...
				throw new Generate_PHPExcel_Writer_Exception("Required floating point format not supported on this platform.");
			}
