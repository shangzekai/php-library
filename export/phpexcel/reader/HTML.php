...
/**
 * Generate_PHPExcel_Reader_HTML
 *
 * @category   Generate_PHPExcel
 * @package    Generate_PHPExcel_Reader
 * @copyright  Copyright (c) 2006 - 2014 Generate_PHPExcel (http://www.codeplex.com/Generate_PHPExcel)
 */
class Generate_PHPExcel_Reader_HTML extends Generate_PHPExcel_Reader_Abstract implements Generate_PHPExcel_Reader_IReader
{
	/**
	 * Input encoding
	 *
	...
	private $_formats = array( 'h1' => array( 'font' => array( 'bold' => true,
							   ...
							   'a'  => array( 'font' => array( 'underline' => true,
															   'color' => array( 'argb' => Generate_PHPExcel_Style_Color::COLOR_BLUE,
															                   ),
															 ),
											),	//	Blue underlined
							   'hr' => array( 'borders' => array( 'bottom' => array( 'style' => Generate_PHPExcel_Style_Border::BORDER_THIN,
																					 'color' => array( Generate_PHPExcel_Style_Color::COLOR_BLACK,
																					                 ),
																				   ),
																),
											),	//	Bottom border
	...
	/**
	 * Create a new Generate_PHPExcel_Reader_HTML
	 */
	...
	//	Data Array used for testing only, should write to Generate_PHPExcel object on completion of tests
...
//						echo 'END OF TABLE ' , $this->_tableLevel , ' CELL<br />';
	...
	public function loadIntoExisting($pFilename, Generate_PHPExcel $objGenerate_PHPExcel)
	{
		...
		if (!$this->_isValidFormat()) {
			...
			throw new Generate_PHPExcel_Reader_Exception($pFilename . " is an Invalid HTML file.");
		}
		...
		$loaded = $dom->loadHTMLFile($pFilename, Generate_PHPExcel_Settings::getLibXmlLoaderOptions());
		if ($loaded === FALSE) {
			throw new Generate_PHPExcel_Reader_Exception('Failed to load ',$pFilename,' as a DOM Document');
		}
		...
		$column = 'A';
		$content = '';
		$this->_processDomElement($dom,$objGenerate_PHPExcel->getActiveSheet(),$row,$column,$content);
...
//		var_dump($this->_dataArray);
	 ...
	 * @return Generate_PHPExcel_Reader_HTML
	 */
