...
/**
 * Generate_PHPExcel_Worksheet_CellIterator
 *
 * Used to iterate rows in a Generate_PHPExcel_Worksheet
 *
 * @category   Generate_PHPExcel
 * @package    Generate_PHPExcel_Worksheet
 * @copyright  Copyright (c) 2006 - 2014 Generate_PHPExcel (http://www.codeplex.com/Generate_PHPExcel)
 */
class Generate_PHPExcel_Worksheet_CellIterator implements Iterator
{
	/**
	 * Generate_PHPExcel_Worksheet to iterate
	 *
	 ...
	 *
	 * @param Generate_PHPExcel_Worksheet 		$subject
	 * @param int						$rowIndex
	 */
	public function __construct(Generate_PHPExcel_Worksheet $subject = null, $rowIndex = 1) {
    ...
    /**
     * Current Generate_PHPExcel_Cell
     *
    ...
    /**
     * Are there any more Generate_PHPExcel_Cell instances available?
     *
     * @return boolean
     */
    public function valid() {
        ...
        // position.
        $columnCount = Generate_PHPExcel_Cell::columnIndexFromString($this->_subject->getHighestColumn());
