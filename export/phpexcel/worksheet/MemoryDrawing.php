...
/**
 * Generate_PHPExcel_Worksheet_MemoryDrawing
 *
 * @category   Generate_PHPExcel
 * @package    Generate_PHPExcel_Worksheet
 * @copyright  Copyright (c) 2006 - 2014 Generate_PHPExcel (http://www.codeplex.com/Generate_PHPExcel)
 */
class Generate_PHPExcel_Worksheet_MemoryDrawing extends Generate_PHPExcel_Worksheet_BaseDrawing implements Generate_PHPExcel_IComparable
{
	/* Rendering functions */
    ...
    /**
     * Create a new Generate_PHPExcel_Worksheet_MemoryDrawing
     */
     ...
     * @return Generate_PHPExcel_Worksheet_MemoryDrawing
     */
     ...
     * @return Generate_PHPExcel_Worksheet_MemoryDrawing
     */
    public function setRenderingFunction($value = Generate_PHPExcel_Worksheet_MemoryDrawing::RENDERING_DEFAULT) {
     ...
     * @return Generate_PHPExcel_Worksheet_MemoryDrawing
     */
    public function setMimeType($value = Generate_PHPExcel_Worksheet_MemoryDrawing::MIMETYPE_DEFAULT) {
