...
/**
 * Generate_PHPExcel_Worksheet_Protection
 *
 * @category   Generate_PHPExcel
 * @package    Generate_PHPExcel_Worksheet
 * @copyright  Copyright (c) 2006 - 2014 Generate_PHPExcel (http://www.codeplex.com/Generate_PHPExcel)
 */
class Generate_PHPExcel_Worksheet_Protection
{
	/**
	 * Sheet
	 *
    ...
    /**
     * Create a new Generate_PHPExcel_Worksheet_Protection
     */
    ...
    function setPassword($pValue = '', $pAlreadyHashed = false) {
    	if (!$pAlreadyHashed) {
    		$pValue = Generate_PHPExcel_Shared_PasswordHasher::hashPassword($pValue);
    	}
