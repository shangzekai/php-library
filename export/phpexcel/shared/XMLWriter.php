...
/**
 * Generate_PHPExcel_Shared_XMLWriter
 *
 * @category   Generate_PHPExcel
 * @package	Generate_PHPExcel_Shared
 * @copyright  Copyright (c) 2006 - 2014 Generate_PHPExcel (http://www.codeplex.com/Generate_PHPExcel)
 */
class Generate_PHPExcel_Shared_XMLWriter extends XMLWriter {
	...
	/**
	 * Create a new Generate_PHPExcel_Shared_XMLWriter instance
	 *
	...
	public function __construct($pTemporaryStorage = self::STORAGE_MEMORY, $pTemporaryStorageFolder = NULL) {
		...
		if ($pTemporaryStorage == self::STORAGE_MEMORY) {
			...
			if ($pTemporaryStorageFolder === NULL)
				$pTemporaryStorageFolder = Generate_PHPExcel_Shared_File::sys_get_temp_dir();
