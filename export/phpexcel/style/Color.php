...
/**
 * Generate_PHPExcel_Style_Color
 *
 * @category   Generate_PHPExcel
 * @package	Generate_PHPExcel_Style
 * @copyright  Copyright (c) 2006 - 2014 Generate_PHPExcel (http://www.codeplex.com/Generate_PHPExcel)
 */
class Generate_PHPExcel_Style_Color extends Generate_PHPExcel_Style_Supervisor implements Generate_PHPExcel_IComparable
{
	/* Colors */
	...
	/**
	 * Create a new Generate_PHPExcel_Style_Color
	 *
	 ...
	 *										its ramifications are
	 */
	public function __construct($pARGB = Generate_PHPExcel_Style_Color::COLOR_BLACK, $isSupervisor = FALSE, $isConditional = FALSE)
	{
		//	Supervisor?
	 ...
	 *
	 * <code>
	 * $objGenerate_PHPExcel->getActiveSheet()->getStyle('B2')->getFont()->getColor()->applyFromArray( array('rgb' => '808080') );
	 * </code>
	 *
	 ...
	 * @return Generate_PHPExcel_Style_Color
	 */
	public function setARGB($pValue = Generate_PHPExcel_Style_Color::COLOR_BLACK) {
		if ($pValue == '') {
			$pValue = Generate_PHPExcel_Style_Color::COLOR_BLACK;
		}
		if ($this->_isSupervisor) {
	...
	public static function indexedColor($pIndex, $background=FALSE) {
		...
		if (array_key_exists($pIndex, self::$_indexedColors)) {
			return new Generate_PHPExcel_Style_Color(self::$_indexedColors[$pIndex]);
		}

		if ($background) {
			return new Generate_PHPExcel_Style_Color('FFFFFFFF');
		}
		return new Generate_PHPExcel_Style_Color('FF000000');
	}
