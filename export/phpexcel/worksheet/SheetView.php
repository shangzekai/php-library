...
/**
 * Generate_PHPExcel_Worksheet_SheetView
 *
 * @category   Generate_PHPExcel
 * @package    Generate_PHPExcel_Worksheet
 * @copyright  Copyright (c) 2006 - 2014 Generate_PHPExcel (http://www.codeplex.com/Generate_PHPExcel)
 */
class Generate_PHPExcel_Worksheet_SheetView
{
    ...
    /**
     * Create a new Generate_PHPExcel_Worksheet_SheetView
     */
	...
	public function setZoomScale($pValue = 100) {
		...
		if (($pValue >= 1) || is_null($pValue)) {
			...
			throw new Generate_PHPExcel_Exception("Scale must be greater than or equal to 1.");
		}
		return $this;
	}
	...
	public function setView($pValue = NULL) {
		...
		if (in_array($pValue, self::$_sheetViewTypes)) {
			...
			throw new Generate_PHPExcel_Exception("Invalid sheetview layout type.");
		}
