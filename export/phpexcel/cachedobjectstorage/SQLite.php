...
/**
 * Generate_PHPExcel_CachedObjectStorage_SQLite
 *
 * @category   Generate_PHPExcel
 * @package    Generate_PHPExcel_CachedObjectStorage
 * @copyright  Copyright (c) 2006 - 2014 Generate_PHPExcel (http://www.codeplex.com/Generate_PHPExcel)
 */
class Generate_PHPExcel_CachedObjectStorage_SQLite extends Generate_PHPExcel_CachedObjectStorage_CacheBase implements Generate_PHPExcel_CachedObjectStorage_ICache {
	...
	protected function _storeData() {
		if ($this->_currentCellIsDirty && !empty($this->_currentObjectID)) {
			...
			if (!$this->_DBHandle->queryExec("INSERT OR REPLACE INTO kvp_".$this->_TableName." VALUES('".$this->_currentObjectID."','".sqlite_escape_string(serialize($this->_currentObject))."')"))
				throw new Generate_PHPExcel_Exception(sqlite_error_string($this->_DBHandle->lastError()));
	...
	public function moveCell($fromAddress, $toAddress) {
		...
		if ($result === false)
			throw new Generate_PHPExcel_Exception($this->_DBHandle->lastErrorMsg());
