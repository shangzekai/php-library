...
/**
 * Generate_PHPExcel_Calculation_Engineering
 *
 * @category	Generate_PHPExcel
 * @package		Generate_PHPExcel_Calculation
 * @copyright	Copyright (c) 2006 - 2014 Generate_PHPExcel (http://www.codeplex.com/Generate_PHPExcel)
 */
class Generate_PHPExcel_Calculation_Engineering {
	...
	public static function BESSELI($x, $ord) {
		$x	= (is_null($x))	? 0.0 :	Generate_PHPExcel_Calculation_Functions::flattenSingleValue($x);
		$ord	= (is_null($ord))	? 0.0 :	Generate_PHPExcel_Calculation_Functions::flattenSingleValue($ord);
		...
		if ((is_numeric($x)) && (is_numeric($ord))) {
			...
			if (abs($x) <= 30) {
				$fResult = $fTerm = pow($x / 2, $ord) / Generate_PHPExcel_Calculation_MathTrig::FACT($ord);
				$ordK = 1;
				$fSqrX = ($x * $x) / 4;
				do {
					$fTerm *= $fSqrX;
			...
			return (is_nan($fResult)) ? Generate_PHPExcel_Calculation_Functions::NaN() : $fResult;
		}
	...
	public static function BESSELK($x, $ord) {
		...
		if ((is_numeric($x)) && (is_numeric($ord))) {
			...
			return (is_nan($fBk)) ? Generate_PHPExcel_Calculation_Functions::NaN() : $fBk;
		}
		return Generate_PHPExcel_Calculation_Functions::VALUE();
	}	//	function BESSELK()
	...
	public static function BESSELY($x, $ord) {
		...
		if ((is_numeric($x)) && (is_numeric($ord))) {
			...
			return (is_nan($fBy)) ? Generate_PHPExcel_Calculation_Functions::NaN() : $fBy;
		}
		return Generate_PHPExcel_Calculation_Functions::VALUE();
	}	//	function BESSELY()
	...
	public static function BINTOHEX($x, $places=NULL) {
		$x	= Generate_PHPExcel_Calculation_Functions::flattenSingleValue($x);
		$places	= Generate_PHPExcel_Calculation_Functions::flattenSingleValue($places);
	...
	public static function COMPLEX($realNumber=0.0, $imaginary=0.0, $suffix='i') {
		$realNumber	= (is_null($realNumber))	? 0.0 :	Generate_PHPExcel_Calculation_Functions::flattenSingleValue($realNumber);
		$imaginary	= (is_null($imaginary))		? 0.0 :	Generate_PHPExcel_Calculation_Functions::flattenSingleValue($imaginary);
		$suffix		= (is_null($suffix))		? 'i' :	Generate_PHPExcel_Calculation_Functions::flattenSingleValue($suffix);
	...
	public static function IMAGINARY($complexNumber) {
		$complexNumber	= Generate_PHPExcel_Calculation_Functions::flattenSingleValue($complexNumber);
	...
	public static function IMPOWER($complexNumber,$realNumber) {
		$complexNumber	= Generate_PHPExcel_Calculation_Functions::flattenSingleValue($complexNumber);
		$realNumber		= Generate_PHPExcel_Calculation_Functions::flattenSingleValue($realNumber);
	...
	public static function IMDIV($complexDividend,$complexDivisor) {
		$complexDividend	= Generate_PHPExcel_Calculation_Functions::flattenSingleValue($complexDividend);
		$complexDivisor	= Generate_PHPExcel_Calculation_Functions::flattenSingleValue($complexDivisor);
	...
	public static function IMSUB($complexNumber1,$complexNumber2) {
		$complexNumber1	= Generate_PHPExcel_Calculation_Functions::flattenSingleValue($complexNumber1);
		$complexNumber2	= Generate_PHPExcel_Calculation_Functions::flattenSingleValue($complexNumber2);
	...
	public static function GESTEP($number, $step=0) {
		...
		$step	= Generate_PHPExcel_Calculation_Functions::flattenSingleValue($step);
	 ...
	 *			Generate_PHPExcel follows Excel 2010 behaviour, and accepts nagative arguments.
	 *
	 *	Excel Function:
	 *		ERF(lower[,upper])
	 *
	...
	public static function ERF($lower, $upper = NULL) {
		$lower	= Generate_PHPExcel_Calculation_Functions::flattenSingleValue($lower);
		$upper	= Generate_PHPExcel_Calculation_Functions::flattenSingleValue($upper);
	...
	public static function CONVERTUOM($value, $fromUOM, $toUOM) {
		...
		$fromUOM	= Generate_PHPExcel_Calculation_Functions::flattenSingleValue($fromUOM);
		$toUOM		= Generate_PHPExcel_Calculation_Functions::flattenSingleValue($toUOM);
