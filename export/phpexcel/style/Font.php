...
/**
 * Generate_PHPExcel_Style_Font
 *
 * @category   Generate_PHPExcel
 * @package	Generate_PHPExcel_Style
 * @copyright  Copyright (c) 2006 - 2014 Generate_PHPExcel (http://www.codeplex.com/Generate_PHPExcel)
 */
class Generate_PHPExcel_Style_Font extends Generate_PHPExcel_Style_Supervisor implements Generate_PHPExcel_IComparable
{
	/* Underline types */
	...
	/**
	 * Create a new Generate_PHPExcel_Style_Font
	 *
	...
	public function __construct($isSupervisor = FALSE, $isConditional = FALSE)
	{
		...
		if ($isConditional) {
			...
			$this->_color			= new Generate_PHPExcel_Style_Color(Generate_PHPExcel_Style_Color::COLOR_BLACK, $isSupervisor, $isConditional);
		} else {
	 ...
	 *
	 * <code>
	 * $objGenerate_PHPExcel->getActiveSheet()->getStyle('B2')->getFont()->applyFromArray(
	 *		array(
	 *			'name'		=> 'Arial',
	 *			'bold'		=> TRUE,
	 *			'italic'	=> FALSE,
	 ...
	 * Set Underline
	 *
	 * @param string|boolean $pValue	Generate_PHPExcel_Style_Font underline type
