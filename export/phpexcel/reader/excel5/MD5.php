...
/**
 * Generate_PHPExcel_Reader_Excel5_MD5
 *
 * @category        Generate_PHPExcel
 * @package                Generate_PHPExcel_Reader_Excel5
 * @copyright        Copyright (c) 2006 - 2014 Generate_PHPExcel (http://www.codeplex.com/Generate_PHPExcel)
 */
class Generate_PHPExcel_Reader_Excel5_MD5
{
    // Context
    private $a;
    private $b;
    ...
    public function add($data)
    {
        ...
        $F = array('Generate_PHPExcel_Reader_Excel5_MD5','F');
        $G = array('Generate_PHPExcel_Reader_Excel5_MD5','G');
        $H = array('Generate_PHPExcel_Reader_Excel5_MD5','H');
        $I = array('Generate_PHPExcel_Reader_Excel5_MD5','I');
