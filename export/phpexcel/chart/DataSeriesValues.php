...
/**
 * Generate_PHPExcel_Chart_DataSeriesValues
 *
 * @category	Generate_PHPExcel
 * @package		Generate_PHPExcel_Chart
 * @copyright	Copyright (c) 2006 - 2014 Generate_PHPExcel (http://www.codeplex.com/Generate_PHPExcel)
 */
class Generate_PHPExcel_Chart_DataSeriesValues
{
	...
	/**
	 * Create a new Generate_PHPExcel_Chart_DataSeriesValues object
	 */
	 ...
	 *								Typical values are:
	 *									Generate_PHPExcel_Chart_DataSeriesValues::DATASERIES_TYPE_STRING
	 *										Normally used for axis point values
	 *									Generate_PHPExcel_Chart_DataSeriesValues::DATASERIES_TYPE_NUMBER
	 *										Normally used for chart data values
	 * @return	Generate_PHPExcel_Chart_DataSeriesValues
	 */
	public function setDataType($dataType = self::DATASERIES_TYPE_NUMBER) {
		if (!in_array($dataType, self::$_dataTypeValues)) {
    		throw new Generate_PHPExcel_Chart_Exception('Invalid datatype for chart data series values');
		}
	...
	public function setDataValues($dataValues = array(), $refreshDataSource = TRUE) {
		$this->_dataValues = Generate_PHPExcel_Calculation_Functions::flattenArray($dataValues);
	...
	public function refresh(Generate_PHPExcel_Worksheet $worksheet, $flatten = TRUE) {
        if ($this->_dataSource !== NULL) {
        	$calcEngine = Generate_PHPExcel_Calculation::getInstance($worksheet->getParent());
			$newDataValues = Generate_PHPExcel_Calculation::_unwrapResult(
			...
			if ($flatten) {
				$this->_dataValues = Generate_PHPExcel_Calculation_Functions::flattenArray($newDataValues);
				...
				$dimensions = Generate_PHPExcel_Cell::rangeDimension(str_replace('$','',$cellRange));
