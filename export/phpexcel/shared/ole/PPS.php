...
*/
class Generate_PHPExcel_Shared_OLE_PPS
{
	/**
	* The PPS index
	* @var integer
	...
	*/
	public function _getPpsWk()
	{
		...
		$ret .= pack("v", strlen($this->Name) + 2)  // 66
			  ...
			  . "\x00\x00\x00\x00"                  // 100
			  . Generate_PHPExcel_Shared_OLE::LocalDate2OLE($this->Time1st)       // 108
			  . Generate_PHPExcel_Shared_OLE::LocalDate2OLE($this->Time2nd)       // 116
