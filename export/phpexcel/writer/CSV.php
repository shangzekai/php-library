 ...
 * @package	Generate_PHPExcel_Writer_CSV
...
/**
 * Generate_PHPExcel_Writer_CSV
 *
 * @category   Generate_PHPExcel
 * @package	Generate_PHPExcel_Writer_CSV
 * @copyright  Copyright (c) 2006 - 2014 Generate_PHPExcel (http://www.codeplex.com/Generate_PHPExcel)
 */
class Generate_PHPExcel_Writer_CSV extends Generate_PHPExcel_Writer_Abstract implements Generate_PHPExcel_Writer_IWriter {
	/**
	...
	/**
	 * Create a new Generate_PHPExcel_Writer_CSV
	 *
	...
	public function save($pFilename = null) {
		// Fetch sheet
		$sheet = $this->_Generate_PHPExcel->getSheet($this->_sheetIndex);
	 ...
	 * @return Generate_PHPExcel_Writer_CSV
	 */
	...
	private function _writeLine($pFileHandle = null, $pValues = null) {
		if (is_array($pValues)) {
			...
			throw new Generate_PHPExcel_Writer_Exception("Invalid data row passed to CSV writer.");
		}
	}
