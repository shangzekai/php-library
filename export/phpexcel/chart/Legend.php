...
/**
 * Generate_PHPExcel_Chart_Legend
 *
 * @category	Generate_PHPExcel
 * @package		Generate_PHPExcel_Chart
 * @copyright	Copyright (c) 2006 - 2014 Generate_PHPExcel (http://www.codeplex.com/Generate_PHPExcel)
 */
class Generate_PHPExcel_Chart_Legend
{
	/** Legend positions */
	...
	/**
	 *	Create a new Generate_PHPExcel_Chart_Legend
	 */
	public function __construct($position = self::POSITION_RIGHT, Generate_PHPExcel_Chart_Layout $layout = NULL, $overlay = FALSE)
	{
