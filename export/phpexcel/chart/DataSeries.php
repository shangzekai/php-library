...
/**
 * Generate_PHPExcel_Chart_DataSeries
 *
 * @category	Generate_PHPExcel
 * @package		Generate_PHPExcel_Chart
 * @copyright	Copyright (c) 2006 - 2014 Generate_PHPExcel (http://www.codeplex.com/Generate_PHPExcel)
 */
class Generate_PHPExcel_Chart_DataSeries
{
	 ...
	 * Plot Label
	 *
	 * @var array of Generate_PHPExcel_Chart_DataSeriesValues
	 */
	...
	/**
	 * Create a new Generate_PHPExcel_Chart_DataSeries
	 */
	public function __construct($plotType = null, $plotGrouping = null, $plotOrder = array(), $plotLabel = array(), $plotCategory = array(), $plotValues = array(), $smoothLine = null, $plotStyle = null)
	{
		...
		if ((count($plotLabel) == 0) || (is_null($plotLabel[$keys[0]]))) {
			$plotLabel[$keys[0]] = new Generate_PHPExcel_Chart_DataSeriesValues();
		}

		$this->_plotLabel = $plotLabel;
		if ((count($plotCategory) == 0) || (is_null($plotCategory[$keys[0]]))) {
			$plotCategory[$keys[0]] = new Generate_PHPExcel_Chart_DataSeriesValues();
		}
	 ...
	 * Get Plot Labels
	 *
	 * @return array of Generate_PHPExcel_Chart_DataSeriesValues
	 */
