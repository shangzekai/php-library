 ...
 * @package		Generate_PHPExcel_Chart
...
/**
 * Generate_PHPExcel_Chart
 *
 * @category	Generate_PHPExcel
 * @package		Generate_PHPExcel_Chart
 * @copyright	Copyright (c) 2006 - 2014 Generate_PHPExcel (http://www.codeplex.com/Generate_PHPExcel)
 */
class Generate_PHPExcel_Chart
{
	/**
	 * Chart Name
	 *
	 ...
	 * Chart Title
	 *
	 * @var Generate_PHPExcel_Chart_Title
	 */
	private $_title = null;
	 ...
	 * Chart Legend
	 *
	 * @var Generate_PHPExcel_Chart_Legend
	 */
	 ...
	 * Chart Plot Area
	 *
	 * @var Generate_PHPExcel_Chart_PlotArea
	 */
	...
	/**
	 * Create a new Generate_PHPExcel_Chart
	 */
	public function __construct($name, Generate_PHPExcel_Chart_Title $title = null, Generate_PHPExcel_Chart_Legend $legend = null, Generate_PHPExcel_Chart_PlotArea $plotArea = null, $plotVisibleOnly = true, $displayBlanksAs = '0', Generate_PHPExcel_Chart_Title $xAxisLabel = null, Generate_PHPExcel_Chart_Title $yAxisLabel = null)
	{
		$this->_name = $name;
		$this->_title = $title;
		$this->_legend = $legend;
	 ...
	 * Set Worksheet
	 *
	 * @param	Generate_PHPExcel_Worksheet	$pValue
	 * @throws	Generate_PHPExcel_Chart_Exception
	 * @return Generate_PHPExcel_Chart
	 */
	public function setWorksheet(Generate_PHPExcel_Worksheet $pValue = null) {
	 ...
	 * Get Title
	 *
	 * @return Generate_PHPExcel_Chart_Title
	 */
	 ...
	 * @return	Generate_PHPExcel_Chart
	 */
	public function setTitle(Generate_PHPExcel_Chart_Title $title) {
		$this->_title = $title;
	 ...
	 * Get Legend
	 *
	 * @return Generate_PHPExcel_Chart_Legend
	 */
	 ...
	 * @return	Generate_PHPExcel_Chart
	 */
	public function setLegend(Generate_PHPExcel_Chart_Legend $legend) {
		$this->_legend = $legend;
	 ...
	 * Set X-Axis Label
	 *
	 * @param	Generate_PHPExcel_Chart_Title $label
	 * @return	Generate_PHPExcel_Chart
	 */
	public function setXAxisLabel(Generate_PHPExcel_Chart_Title $label) {
	 ...
	 * @return	Generate_PHPExcel_Chart
	 */
	public function setYAxisLabel(Generate_PHPExcel_Chart_Title $label) {
	 ...
	 * Get Plot Area
	 *
	 * @return Generate_PHPExcel_Chart_PlotArea
	 */
	...
	public function render($outputDestination = null) {
		$libraryName = Generate_PHPExcel_Settings::getChartRendererName();
		...
		$libraryPath = Generate_PHPExcel_Settings::getChartRendererPath();
		...
		$rendererName = 'Generate_PHPExcel_Chart_Renderer_'.$libraryName;
