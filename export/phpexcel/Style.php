...
/**
 * Generate_PHPExcel_Style
 *
 * @category   Generate_PHPExcel
 * @package    Generate_PHPExcel_Style
 * @copyright  Copyright (c) 2006 - 2014 Generate_PHPExcel (http://www.codeplex.com/Generate_PHPExcel)
 */
class Generate_PHPExcel_Style extends Generate_PHPExcel_Style_Supervisor implements Generate_PHPExcel_IComparable
{
    /**
     * Font
     *
     ...
     * Fill
     *
     * @var Generate_PHPExcel_Style_Fill
     */
    protected $_fill;
     ...
     * Borders
     *
     * @var Generate_PHPExcel_Style_Borders
     */
    protected $_borders;
     ...
     * Alignment
     *
     * @var Generate_PHPExcel_Style_Alignment
     */
     ...
     * Number Format
     *
     * @var Generate_PHPExcel_Style_NumberFormat
     */
     ...
     * Conditional styles
     *
     * @var Generate_PHPExcel_Style_Conditional[]
     */
     ...
     * Protection
     *
     * @var Generate_PHPExcel_Style_Protection
     */
    ...
    /**
     * Create a new Generate_PHPExcel_Style
     *
    ...
    public function __construct($isSupervisor = false, $isConditional = false)
    {
        ...
        $this->_font              = new Generate_PHPExcel_Style_Font($isSupervisor, $isConditional);
        $this->_fill              = new Generate_PHPExcel_Style_Fill($isSupervisor, $isConditional);
        $this->_borders           = new Generate_PHPExcel_Style_Borders($isSupervisor, $isConditional);
        $this->_alignment         = new Generate_PHPExcel_Style_Alignment($isSupervisor, $isConditional);
        $this->_numberFormat      = new Generate_PHPExcel_Style_NumberFormat($isSupervisor, $isConditional);
        $this->_protection        = new Generate_PHPExcel_Style_Protection($isSupervisor, $isConditional);
     ...
     *
     * <code>
     * $objGenerate_PHPExcel->getActiveSheet()->getStyle('B2')->applyFromArray(
     *         array(
     *             'font'    => array(
     *                 'name'      => 'Arial',
     *                 'bold'      => true,
     *                 'italic'    => false,
     *                 'underline' => Generate_PHPExcel_Style_Font::UNDERLINE_DOUBLE,
     *                 'strike'    => false,
     *                 'color'     => array(
     *                     'rgb' => '808080'
     *                 )
    ...
    public function applyFromArray($pStyles = null, $pAdvanced = true)
    {
        if (is_array($pStyles)) {
            if ($this->_isSupervisor) {
                ...
                $rangeStart = Generate_PHPExcel_Cell::coordinateFromString($rangeA);
                $rangeEnd     = Generate_PHPExcel_Cell::coordinateFromString($rangeB);

                // Translate column into index
                $rangeStart[0]    = Generate_PHPExcel_Cell::columnIndexFromString($rangeStart[0]) - 1;
                $rangeEnd[0]    = Generate_PHPExcel_Cell::columnIndexFromString($rangeEnd[0]) - 1;
                ...
                if ($pAdvanced && isset($pStyles['borders'])) {
                    ...
                    for ($x = 1; $x <= $xMax; ++$x) {
                        ...
                        $colStart = ($x == 3) ?
                            Generate_PHPExcel_Cell::stringFromColumnIndex($rangeEnd[0])
                                : Generate_PHPExcel_Cell::stringFromColumnIndex($rangeStart[0] + $x - 1);

                        // end column index for region
                        $colEnd = ($x == 1) ?
                            Generate_PHPExcel_Cell::stringFromColumnIndex($rangeStart[0])
                                : Generate_PHPExcel_Cell::stringFromColumnIndex($rangeEnd[0] - $xMax + $x);
     ...
     * Get Fill
     *
     * @return Generate_PHPExcel_Style_Fill
     */
     ...
     * @return Generate_PHPExcel_Style
     */
    public function setFont(Generate_PHPExcel_Style_Font $font)
    {
        $this->_font = $font;
        return $this;
    }
     ...
     * Get Alignment
     *
     * @return Generate_PHPExcel_Style_Alignment
     */
     ...
     * Get Number Format
     *
     * @return Generate_PHPExcel_Style_NumberFormat
     */
     ...
     *
     * @param Generate_PHPExcel_Style_Conditional[] $pValue Array of condtional styles
     * @return Generate_PHPExcel_Style
     */
     ...
     * Get Protection
     *
     * @return Generate_PHPExcel_Style_Protection
     */
