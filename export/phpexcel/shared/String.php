...
/**
 * Generate_PHPExcel_Shared_String
 *
 * @category   Generate_PHPExcel
 * @package    Generate_PHPExcel_Shared
 * @copyright  Copyright (c) 2006 - 2014 Generate_PHPExcel (http://www.codeplex.com/Generate_PHPExcel)
 */
class Generate_PHPExcel_Shared_String
{
	/**	Constants				*/
	/**	Regular Expressions		*/
	//	Fraction
	...
	public static function convertToNumberIfFraction(&$operand) {
		if (preg_match('/^'.self::STRING_REGEXP_FRACTION.'$/i', $operand, $match)) {
			...
			$operand = Generate_PHPExcel_Calculation::getInstance()->_calculateFormulaValue($fractionFormula);
			return true;
		}
		return false;
	...
	/**
	 * Set the decimal separator. Only used by Generate_PHPExcel_Style_NumberFormat::toFormattedString()
	 * to format output by Generate_PHPExcel_Writer_HTML and Generate_PHPExcel_Writer_PDF
	 *
	...
	/**
	 * Set the thousands separator. Only used by Generate_PHPExcel_Style_NumberFormat::toFormattedString()
	 * to format output by Generate_PHPExcel_Writer_HTML and Generate_PHPExcel_Writer_PDF
	 *
	...
	/**
	 * Set the currency code. Only used by Generate_PHPExcel_Style_NumberFormat::toFormattedString()
	 *		to format output by Generate_PHPExcel_Writer_HTML and Generate_PHPExcel_Writer_PDF
	 *
