...
/**
 * Generate_PHPExcel_Worksheet_HeaderFooter
 *
 * <code>
 ...
 * @copyright  Copyright (c) 2006 - 2014 Generate_PHPExcel (http://www.codeplex.com/Generate_PHPExcel)
 */
class Generate_PHPExcel_Worksheet_HeaderFooter
{
	 ...
	 *
	 * @var Generate_PHPExcel_Worksheet_HeaderFooterDrawing[]
	 */
	private $_headerFooterImages = array();

    /**
     * Create a new Generate_PHPExcel_Worksheet_HeaderFooter
     */
     ...
     *
     * @param Generate_PHPExcel_Worksheet_HeaderFooterDrawing $image
     * @param string $location
     * @throws Generate_PHPExcel_Exception
     * @return Generate_PHPExcel_Worksheet_HeaderFooter
     */
    public function addImage(Generate_PHPExcel_Worksheet_HeaderFooterDrawing $image = null, $location = self::IMAGE_HEADER_LEFT) {
     ...
     *
     * @param Generate_PHPExcel_Worksheet_HeaderFooterDrawing[] $images
     * @throws Generate_PHPExcel_Exception
     * @return Generate_PHPExcel_Worksheet_HeaderFooter
     */
    public function setImages($images) {
    	if (!is_array($images)) {
    		throw new Generate_PHPExcel_Exception('Invalid parameter!');
    	}
     ...
     *
     * @return Generate_PHPExcel_Worksheet_HeaderFooterDrawing[]
     */
