...
require_once Generate_PHPExcel_ROOT . 'Generate_PHPExcel/Shared/trend/bestFitClass.php';
require_once Generate_PHPExcel_ROOT . 'Generate_PHPExcel/Shared/JAMA/Matrix.php';


/**
 * Generate_PHPExcel_Polynomial_Best_Fit
 *
 * @category   Generate_PHPExcel
 * @package    Generate_PHPExcel_Shared_Trend
 * @copyright  Copyright (c) 2006 - 2014 Generate_PHPExcel (http://www.codeplex.com/Generate_PHPExcel)
 */
class Generate_PHPExcel_Polynomial_Best_Fit extends Generate_PHPExcel_Best_Fit
{
	/**
