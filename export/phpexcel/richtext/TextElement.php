...
/**
 * Generate_PHPExcel_RichText_TextElement
 *
 * @category   Generate_PHPExcel
 * @package    Generate_PHPExcel_RichText
 * @copyright  Copyright (c) 2006 - 2014 Generate_PHPExcel (http://www.codeplex.com/Generate_PHPExcel)
 */
class Generate_PHPExcel_RichText_TextElement implements Generate_PHPExcel_RichText_ITextElement
{
	/**
	 * Text
	 *
    ...
    /**
     * Create a new Generate_PHPExcel_RichText_TextElement instance
     *
