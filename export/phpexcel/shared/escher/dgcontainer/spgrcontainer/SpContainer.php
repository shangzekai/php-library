...
/**
 * Generate_PHPExcel_Shared_Escher_DgContainer_SpgrContainer_SpContainer
 *
 * @category   Generate_PHPExcel
 * @package    Generate_PHPExcel_Shared_Escher
 * @copyright  Copyright (c) 2006 - 2014 Generate_PHPExcel (http://www.codeplex.com/Generate_PHPExcel)
 */
class Generate_PHPExcel_Shared_Escher_DgContainer_SpgrContainer_SpContainer
{
	/**
	 ...
	 *
	 * @return Generate_PHPExcel_Shared_Escher_DgContainer_SpgrContainer
	 */
	...
	public function getNestingLevel()
	{
		...
		while ($parent instanceof Generate_PHPExcel_Shared_Escher_DgContainer_SpgrContainer) {
			++$nestingLevel;
