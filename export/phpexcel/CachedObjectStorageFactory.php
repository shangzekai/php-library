...
/**
 * Generate_PHPExcel_CachedObjectStorageFactory
 *
 * @category    Generate_PHPExcel
 * @package        Generate_PHPExcel_CachedObjectStorage
 * @copyright    Copyright (c) 2006 - 2014 Generate_PHPExcel (http://www.codeplex.com/Generate_PHPExcel)
 */
class Generate_PHPExcel_CachedObjectStorageFactory
{
     ...
     *
     * @return Generate_PHPExcel_CachedObjectStorage_ICache|NULL
     **/
    ...
    public static function getCacheStorageMethods()
    {
        ...
        foreach(self::$_storageMethods as $storageMethod) {
            $cacheStorageClass = 'Generate_PHPExcel_CachedObjectStorage_' . $storageMethod;
    ...
    public static function initialize($method = self::cache_in_memory, $arguments = array())
    {
        ...
        $cacheStorageClass = 'Generate_PHPExcel_CachedObjectStorage_'.$method;
        ...
        if (self::$_cacheStorageMethod === NULL) {
            self::$_cacheStorageClass = 'Generate_PHPExcel_CachedObjectStorage_' . $method;
     ...
     *
     * @param    Generate_PHPExcel_Worksheet     $parent        Enable cell caching for this worksheet
     * @return    Generate_PHPExcel_CachedObjectStorage_ICache
     **/
    public static function getInstance(Generate_PHPExcel_Worksheet $parent)
    {
