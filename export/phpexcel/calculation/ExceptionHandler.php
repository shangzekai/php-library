...
/**
 * Generate_PHPExcel_Calculation_ExceptionHandler
 *
 * @category   Generate_PHPExcel
 * @package    Generate_PHPExcel_Calculation
 * @copyright  Copyright (c) 2006 - 2014 Generate_PHPExcel (http://www.codeplex.com/Generate_PHPExcel)
 */
class Generate_PHPExcel_Calculation_ExceptionHandler {
	/**
	 * Register errorhandler
	 */
	public function __construct() {
		set_error_handler(array('Generate_PHPExcel_Calculation_Exception', 'errorHandlerCallback'), E_ALL);
	}
