...
/**
 * Generate_PHPExcel_Style_Alignment
 *
 * @category   Generate_PHPExcel
 * @package	Generate_PHPExcel_Style
 * @copyright  Copyright (c) 2006 - 2014 Generate_PHPExcel (http://www.codeplex.com/Generate_PHPExcel)
 */
class Generate_PHPExcel_Style_Alignment extends Generate_PHPExcel_Style_Supervisor implements Generate_PHPExcel_IComparable
{
	 ...
	 * @var string
	 */
	protected $_horizontal	= Generate_PHPExcel_Style_Alignment::HORIZONTAL_GENERAL;
	 ...
	 * @var string
	 */
	protected $_vertical		= Generate_PHPExcel_Style_Alignment::VERTICAL_BOTTOM;
	...
	/**
	 * Create a new Generate_PHPExcel_Style_Alignment
	 *
	 ...
	 *
	 * <code>
	 * $objGenerate_PHPExcel->getActiveSheet()->getStyle('B2')->getAlignment()->applyFromArray(
	 *		array(
	 *			'horizontal' => Generate_PHPExcel_Style_Alignment::HORIZONTAL_CENTER,
	 *			'vertical'   => Generate_PHPExcel_Style_Alignment::VERTICAL_CENTER,
	 *			'rotation'   => 0,
	 *			'wrap'			=> TRUE
	 *		)
	 * );
	 ...
	 * @return Generate_PHPExcel_Style_Alignment
	 */
	public function setHorizontal($pValue = Generate_PHPExcel_Style_Alignment::HORIZONTAL_GENERAL) {
		if ($pValue == '') {
			$pValue = Generate_PHPExcel_Style_Alignment::HORIZONTAL_GENERAL;
		}
	 ...
	 * @return Generate_PHPExcel_Style_Alignment
	 */
	public function setVertical($pValue = Generate_PHPExcel_Style_Alignment::VERTICAL_BOTTOM) {
		if ($pValue == '') {
			$pValue = Generate_PHPExcel_Style_Alignment::VERTICAL_BOTTOM;
		}
	...
	public function setTextRotation($pValue = 0) {
		// Excel2007 value 255 => Generate_PHPExcel value -165
		if ($pValue == 255) {
			$pValue = -165;
		}
		...
		if ( ($pValue >= -90 && $pValue <= 90) || $pValue == -165 ) {
			...
			throw new Generate_PHPExcel_Exception("Text rotation should be a value between -90 and 90.");
		}
