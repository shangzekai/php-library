...
/**
 * Generate_PHPExcel_CachedObjectStorage_Igbinary
 *
 * @category   Generate_PHPExcel
 * @package    Generate_PHPExcel_CachedObjectStorage
 * @copyright  Copyright (c) 2006 - 2014 Generate_PHPExcel (http://www.codeplex.com/Generate_PHPExcel)
 */
class Generate_PHPExcel_CachedObjectStorage_Igbinary extends Generate_PHPExcel_CachedObjectStorage_CacheBase implements Generate_PHPExcel_CachedObjectStorage_ICache {
