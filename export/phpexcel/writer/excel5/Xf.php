...
/**
 * Generate_PHPExcel_Writer_Excel5_Xf
 *
 * @category   Generate_PHPExcel
 * @package    Generate_PHPExcel_Writer_Excel5
 * @copyright  Copyright (c) 2006 - 2014 Generate_PHPExcel (http://www.codeplex.com/Generate_PHPExcel)
 */
class Generate_PHPExcel_Writer_Excel5_Xf
{
    /**
	...
	*/
	 ...
	 *
	 * @access public
	 * @param Generate_PHPExcel_Style	The XF format
	 */
	public function __construct(Generate_PHPExcel_Style $style = null)
	{
	...
	function writeXf()
	{
		...
		$diag_tl_to_rb = $diagonalDirection == Generate_PHPExcel_Style_Borders::DIAGONAL_BOTH
							|| $diagonalDirection == Generate_PHPExcel_Style_Borders::DIAGONAL_DOWN;
		$diag_tr_to_lb = $diagonalDirection == Generate_PHPExcel_Style_Borders::DIAGONAL_BOTH
							|| $diagonalDirection == Generate_PHPExcel_Style_Borders::DIAGONAL_UP;
	 ...
	 *
	 */
	private static $_mapBorderStyle = array	( Generate_PHPExcel_Style_Border::BORDER_NONE				=> 0x00,
											  Generate_PHPExcel_Style_Border::BORDER_THIN				=> 0x01,
											  Generate_PHPExcel_Style_Border::BORDER_MEDIUM				=> 0x02,
											  Generate_PHPExcel_Style_Border::BORDER_DASHED				=> 0x03,
											  Generate_PHPExcel_Style_Border::BORDER_DOTTED				=> 0x04,
											  Generate_PHPExcel_Style_Border::BORDER_THICK				=> 0x05,
											  Generate_PHPExcel_Style_Border::BORDER_DOUBLE				=> 0x06,
											  Generate_PHPExcel_Style_Border::BORDER_HAIR				=> 0x07,
											  Generate_PHPExcel_Style_Border::BORDER_MEDIUMDASHED		=> 0x08,
											  Generate_PHPExcel_Style_Border::BORDER_DASHDOT				=> 0x09,
											  Generate_PHPExcel_Style_Border::BORDER_MEDIUMDASHDOT		=> 0x0A,
											  Generate_PHPExcel_Style_Border::BORDER_DASHDOTDOT			=> 0x0B,
											  Generate_PHPExcel_Style_Border::BORDER_MEDIUMDASHDOTDOT	=> 0x0C,
											  Generate_PHPExcel_Style_Border::BORDER_SLANTDASHDOT		=> 0x0D,
											);
	 ...
	 *
	 */
	private static $_mapFillType = array( Generate_PHPExcel_Style_Fill::FILL_NONE					=> 0x00,
										  Generate_PHPExcel_Style_Fill::FILL_SOLID					=> 0x01,
										  Generate_PHPExcel_Style_Fill::FILL_PATTERN_MEDIUMGRAY		=> 0x02,
										  Generate_PHPExcel_Style_Fill::FILL_PATTERN_DARKGRAY		=> 0x03,
										  Generate_PHPExcel_Style_Fill::FILL_PATTERN_LIGHTGRAY		=> 0x04,
										  Generate_PHPExcel_Style_Fill::FILL_PATTERN_DARKHORIZONTAL	=> 0x05,
										  Generate_PHPExcel_Style_Fill::FILL_PATTERN_DARKVERTICAL	=> 0x06,
										  Generate_PHPExcel_Style_Fill::FILL_PATTERN_DARKDOWN		=> 0x07,
										  Generate_PHPExcel_Style_Fill::FILL_PATTERN_DARKUP			=> 0x08,
										  Generate_PHPExcel_Style_Fill::FILL_PATTERN_DARKGRID		=> 0x09,
										  Generate_PHPExcel_Style_Fill::FILL_PATTERN_DARKTRELLIS		=> 0x0A,
										  Generate_PHPExcel_Style_Fill::FILL_PATTERN_LIGHTHORIZONTAL	=> 0x0B,
										  Generate_PHPExcel_Style_Fill::FILL_PATTERN_LIGHTVERTICAL	=> 0x0C,
										  Generate_PHPExcel_Style_Fill::FILL_PATTERN_LIGHTDOWN		=> 0x0D,
										  Generate_PHPExcel_Style_Fill::FILL_PATTERN_LIGHTUP			=> 0x0E,
										  Generate_PHPExcel_Style_Fill::FILL_PATTERN_LIGHTGRID		=> 0x0F,
										  Generate_PHPExcel_Style_Fill::FILL_PATTERN_LIGHTTRELLIS	=> 0x10,
										  Generate_PHPExcel_Style_Fill::FILL_PATTERN_GRAY125			=> 0x11,
										  Generate_PHPExcel_Style_Fill::FILL_PATTERN_GRAY0625		=> 0x12,
										  Generate_PHPExcel_Style_Fill::FILL_GRADIENT_LINEAR			=> 0x00,	// does not exist in BIFF8
										  Generate_PHPExcel_Style_Fill::FILL_GRADIENT_PATH			=> 0x00,	// does not exist in BIFF8
										);
	/**
	 * Map fill type
	 *
	 ...
	 *
	 */
	private static $_mapHAlign = array( Generate_PHPExcel_Style_Alignment::HORIZONTAL_GENERAL			=> 0,
										Generate_PHPExcel_Style_Alignment::HORIZONTAL_LEFT				=> 1,
										Generate_PHPExcel_Style_Alignment::HORIZONTAL_CENTER				=> 2,
										Generate_PHPExcel_Style_Alignment::HORIZONTAL_RIGHT				=> 3,
										Generate_PHPExcel_Style_Alignment::HORIZONTAL_FILL				=> 4,
										Generate_PHPExcel_Style_Alignment::HORIZONTAL_JUSTIFY			=> 5,
										Generate_PHPExcel_Style_Alignment::HORIZONTAL_CENTER_CONTINUOUS	=> 6,
									  );
	/**
	 ...
	 *
	 */
	private static $_mapVAlign = array( Generate_PHPExcel_Style_Alignment::VERTICAL_TOP		=> 0,
										Generate_PHPExcel_Style_Alignment::VERTICAL_CENTER	=> 1,
										Generate_PHPExcel_Style_Alignment::VERTICAL_BOTTOM	=> 2,
										Generate_PHPExcel_Style_Alignment::VERTICAL_JUSTIFY	=> 3,
									  );
	/**
	...
	private static function _mapLocked($locked) {
		switch ($locked) {
			case Generate_PHPExcel_Style_Protection::PROTECTION_INHERIT:		return 1;
			case Generate_PHPExcel_Style_Protection::PROTECTION_PROTECTED:	return 1;
			case Generate_PHPExcel_Style_Protection::PROTECTION_UNPROTECTED:	return 0;
			default:												return 1;
		}
	}
	...
	private static function _mapHidden($hidden) {
		switch ($hidden) {
			case Generate_PHPExcel_Style_Protection::PROTECTION_INHERIT:		return 0;
			case Generate_PHPExcel_Style_Protection::PROTECTION_PROTECTED:	return 1;
			case Generate_PHPExcel_Style_Protection::PROTECTION_UNPROTECTED:	return 0;
			default:												return 0;
		}
