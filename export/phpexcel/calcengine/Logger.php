...
/**
 * Generate_PHPExcel_CalcEngine_Logger
 *
 * @category	Generate_PHPExcel
 * @package		Generate_PHPExcel_Calculation
 * @copyright	Copyright (c) 2006 - 2014 Generate_PHPExcel (http://www.codeplex.com/Generate_PHPExcel)
 */
class Generate_PHPExcel_CalcEngine_Logger {
	 ...
	 *
	 * @var Generate_PHPExcel_CalcEngine_CyclicReferenceStack
	 */
	private $_cellStack;
	 ...
	 *
	 * @param  Generate_PHPExcel_CalcEngine_CyclicReferenceStack $stack
	 */
	public function __construct(Generate_PHPExcel_CalcEngine_CyclicReferenceStack $stack) {
