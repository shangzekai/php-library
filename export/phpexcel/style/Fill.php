...
/**
 * Generate_PHPExcel_Style_Fill
 *
 * @category   Generate_PHPExcel
 * @package	Generate_PHPExcel_Style
 * @copyright  Copyright (c) 2006 - 2014 Generate_PHPExcel (http://www.codeplex.com/Generate_PHPExcel)
 */
class Generate_PHPExcel_Style_Fill extends Generate_PHPExcel_Style_Supervisor implements Generate_PHPExcel_IComparable
{
	/* Fill types */
	 ...
	 * @var string
	 */
	protected $_fillType	= Generate_PHPExcel_Style_Fill::FILL_NONE;
	...
	/**
	 * Create a new Generate_PHPExcel_Style_Fill
	 *
	...
	public function __construct($isSupervisor = FALSE, $isConditional = FALSE)
	{
		...
		$this->_startColor			= new Generate_PHPExcel_Style_Color(Generate_PHPExcel_Style_Color::COLOR_WHITE, $isSupervisor, $isConditional);
		$this->_endColor			= new Generate_PHPExcel_Style_Color(Generate_PHPExcel_Style_Color::COLOR_BLACK, $isSupervisor, $isConditional);
	 ...
	 *
	 * <code>
	 * $objGenerate_PHPExcel->getActiveSheet()->getStyle('B2')->getFill()->applyFromArray(
	 *		array(
	 *			'type'	   => Generate_PHPExcel_Style_Fill::FILL_GRADIENT_LINEAR,
	 *			'rotation'   => 0,
	 *			'startcolor' => array(
	 *				'rgb' => '000000'
	 *			),
	 ...
	 * Set Fill Type
	 *
	 * @param string $pValue	Generate_PHPExcel_Style_Fill fill type
	 * @return Generate_PHPExcel_Style_Fill
	 */
	public function setFillType($pValue = Generate_PHPExcel_Style_Fill::FILL_NONE) {
		if ($this->_isSupervisor) {
	 ...
	 * @return Generate_PHPExcel_Style_Fill
	 */
	public function setStartColor(Generate_PHPExcel_Style_Color $pValue = null) {
	 ...
	 * @return Generate_PHPExcel_Style_Fill
	 */
	public function setEndColor(Generate_PHPExcel_Style_Color $pValue = null) {
		// make sure parameter is a real color and not a supervisor
		$color = $pValue->getIsSupervisor() ? $pValue->getSharedComponent() : $pValue;
